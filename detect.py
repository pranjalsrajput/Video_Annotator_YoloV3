...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="data/sample1", help="path to dataset")
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        if bool_skip:
            ...
            writer.writerow(["x1, y1, x2, y2, box_w, box_h, bibId"])
            #file.write("x1, y1, x2, y2, box_w, box_h \n")
